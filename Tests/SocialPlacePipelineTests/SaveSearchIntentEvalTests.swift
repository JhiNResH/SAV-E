...
final class SaveSearchIntentEvalTests: XCTestCase {
    ...
    func testGeminiModelOrderPrefersFlashBeforeFlashLite() {
        XCTAssertEqual(SaveAIService.defaultModelFallbacks.prefix(2), ["gemini-2.5-flash", "gemini-2.5-flash-lite"])
    }
