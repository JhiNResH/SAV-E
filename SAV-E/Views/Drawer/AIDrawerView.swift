    ...
    private var socialMapTabView: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 14) {
                SpotDrawerCTA(onAddSpots: focusSocialInvestigationPrompt)
                socialSignalSection
    ...
    var body: some View {
        VStack(spacing: 20) {
            ...
            Button(action: onAddSpots) {
                ...
                .background {
                    Capsule()
                        .fill(colorScheme == .dark ? Color.white.opacity(0.15) : Color.white.opacity(0.92))
        ...
        .background {
            RoundedRectangle(cornerRadius: 28, style: .continuous)
                ...
                .overlay(
                    colorScheme == .dark
                        ? Color.saveNotebookPage.opacity(0.64)
                        : Color.white.opacity(0.84)
                )
        }
        .overlay(
            RoundedRectangle(cornerRadius: 28, style: .continuous)
                .stroke(Color.saveNotebookLine.opacity(colorScheme == .dark ? 0.24 : 0.10), lineWidth: 1)
        )
    ...
    var body: some View {
        ZStack(alignment: .bottom) {
            VStack(spacing: 0) {
                Spacer(minLength: 0)
                Rectangle()
                    .fill(Color.saveNotebookSpine.opacity(0.35))
                    .frame(height: 18)
                    .overlay(alignment: .top) {
                        Rectangle()
            ...
            HStack(alignment: .bottom, spacing: 12) {
                VStack(spacing: 6) {
                    ...
                    spotToken(systemName: "location", tint: .saveSky)
                }
                ...
                ZStack(alignment: .center) {
                    ...
                    HStack(spacing: 0) {
                        ...
                        mapPanel(fill: Color.white.opacity(0.86), line: Color.saveSky.opacity(0.38))
                        mapPanel(fill: Color.saveCream.opacity(0.90), line: Color.saveHoney.opacity(0.36))
                    }
                    .rotationEffect(.degrees(-2))
